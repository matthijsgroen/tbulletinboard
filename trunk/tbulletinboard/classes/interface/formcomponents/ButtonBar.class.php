<?php
	 ...
	 */
	class FormButtonBar extends FormContainer {
		function FormButtonBar($title, $description, $name, $buttons = array()) {
			$this->FormContainer($title, $description, $name);
			$this->setComponents($buttons);
			$this->rowClass = "buttonbar";
		}

		function getInput() {
			$result = '';
			$result .= '<span class="buttonbar">'."\n";
