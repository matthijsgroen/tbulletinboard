<?php
	...
	require_once($ivLibDir . 'formcomponents/NumberField.class.php');
	require_once($ivLibDir . 'formcomponents/TextField.class.php');
	require_once($ivLibDir . 'formcomponents/Date.class.php');
	require_once($ivLibDir . 'formcomponents/Time.class.php');
	*/
	...
	class TravianAttackTopicPlugin extends TopicPlugin {
		...
		function TravianAttackTopicPlugin() {
			$this->TopicPlugin();
		}

		function getSelectionName() {
			return "Travian Aanval";
		}
