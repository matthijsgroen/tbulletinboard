		...
		function findXPos(obj) {
			...
			curleft += obj.x;
			var browserOffset = 0;
			if (is.ie) browserOffset = 2;

			return curleft + browserOffset;
		}
		...
		function findYPos(obj) {
			...
			curtop += obj.y;
			var browserOffset = 0;
			if (is.ie) browserOffset = 3;			
			
			return curtop + browserOffset;
		}		

		function getWidth(obj) {
			if (is.ie) return obj.offsetWidth - 2;
			return obj.offsetWidth;
		}

		function getHeight(obj) {
			if (is.ie) return obj.offsetHeight - 3;
			return obj.offsetHeight;
		}

// Ultimate client-side JavaScript client sniff. Version 3.10
//  ultsniff.js
// (c) Netscape Communications 1999.  Permission granted to reuse and distribute.

// Revised 08-Feb-05 D'n Russler, http://www.Loryx.com add Op 6,Op 7,NS7
//  Loryx.com reiterates permission granted to reuse and distribute.
...
{   // convert all characters to lowercase to simplify testing
    ...
    this.nav7 = (this.nav
          && ((ps=agt.indexOf("netscape/")) > -1)
          && (parseInt(nsVer=agt.substr(ps+9,agt.indexOf(' ',ps)-ps-9)) >= 7)
            );
    ...
    this.opera5up = (this.opera && !this.opera2 && !this.opera3 && !this.opera4 && !this.opera4);
